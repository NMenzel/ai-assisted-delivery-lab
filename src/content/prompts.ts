...
export const promptDefinitions: PromptDefinition[] = [
  {
    ...
    whenToUse: "Use for small UI, utility, or testable behavior with clear requirements.",
    requiredInput: ["Requirement", "Affected files", "Constraints", "Acceptance criteria", "Test expectations"],
    prompt:
    ...
    expectedOutput: "Small patch, assumptions, risk notes, and verification guidance.",
    humanReview: "Required before merge.",
    failureModes: ["Scope creep", "Hallucinated APIs", "Hidden behavior changes", "Weak tests"],
  },
  {
    slug: "refactoring",
    ...
    whenToUse: "Use when extracting components, reducing duplication, or improving names.",
    requiredInput: ["Current behavior", "Target files", "Protected behaviors", "Test commands"],
    prompt:
    ...
    failureModes: ["Accidental API changes", "Deleted edge cases", "Over-abstraction"],
  },
  {
    slug: "pr-review",
    ...
    requiredInput: ["PR summary", "Diff", "Acceptance criteria", "Architecture context"],
    prompt:
    ...
    failureModes: ["False positives", "Missed domain context", "Noisy style comments"],
  },
  {
    slug: "security-review",
    title: "Security Risk Scan",
    category: "Security Review",
    purpose: "Identify security risks in code, prompts, agent workflows, or permissions.",
    whenToUse: "Use for auth, data handling, dependencies, agents, or external integrations.",
    requiredInput: ["Diff", "Data classes", "Permission model", "Trust boundaries"],
    prompt:
    ...
    expectedOutput: "Threats, mitigations, exploit scenarios, and unresolved questions.",
    humanReview: "Security owner review required for high-risk changes.",
    failureModes: ["Missing business-specific threats", "Speculative findings", "False confidence"],
  },
  {
    ...
    whenToUse: "Use for new components, changed flows, forms, navigation, and dashboards.",
    requiredInput: ["UI requirements", "Relevant code", "Expected user flow", "Known constraints"],
    prompt:
    ...
    expectedOutput: "Likely issues, manual tests, false-positive risks, and required human verification.",
    humanReview: "Mandatory for compliance-sensitive claims.",
    failureModes: ["False positives", "Missed assistive technology behavior", "Incomplete manual evidence"],
  },
  {
    ...
    whenToUse: "Use for new modules, data flows, dependency boundaries, and cross-cutting changes.",
    requiredInput: ["Architecture context", "Proposed change", "Affected files", "Constraints"],
    prompt:
    ...
    failureModes: ["Overengineering", "Ignoring delivery constraints", "Inventing missing architecture"],
  },
  {
    ...
    failureModes: ["Lost nuance", "Missed edge cases", "Unsafe for high-risk work"],
  },
];
